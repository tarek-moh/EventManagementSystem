...
public class Database{
    ...
    static {
        ...
        adminList.add(new Admin("Amr", "password123", LocalDate.of(2002, 4, 20), "models.Event Manager", "09-16"));
        adminList.add(new Admin("Ehab", "adminpass", LocalDate.of(1995, 3, 10), "Venue Coordinator", "08-14"));
        adminList.add(new Admin("Lina", "novelQueen", LocalDate.of(2001, 11, 3), "Tech Supervisor", "10-18"));
        ...
        organizerList.add(new Organizer("Mohamed", "password123", LocalDate.of(2002, 4, 20)));
        organizerList.add(new Organizer("Ramy", "organizer456", LocalDate.of(1999, 8, 12)));
        organizerList.add(new Organizer("Joudy", "mysteryBooks", LocalDate.of(2001, 11, 3)));
        organizerList.add(new Organizer("Fatima", "eventsPro", LocalDate.of(1997, 2, 27)));
