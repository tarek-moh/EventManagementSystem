...
public class Attendee extends User
{
    ...
    public void showDashboard() {
        while (true) {
            ...
            switch (choice) {
                ...
                case 3:
                    while(true) {
                        System.out.print("Enter event title (done to exit): ");
                        ...
                        for (Event e : Database.getEventList())
                            if (e.getTitle().equalsIgnoreCase(title))
                                ev = e;
                        if (ev != null) {
                            System.out.print("Ticket Price is " + ev.getTicketPrice() + " write confirm to continue:");
    ...
    private void displayProfileMenu() {
        ...
        System.out.println("Gender                4: Change gender\n" + getGender() + "\n");
    ...
    {
        System.out.print("Enter new gender (1:Male    2:Female): ");
        input.nextLine(); // Clear buffer
        short select = getValidChoice(1, 2);
        setGender(select);
    }
